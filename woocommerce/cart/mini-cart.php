...
<?php if (!WC()->cart->is_empty()) : ?>
    ...
    <div class="dropdown-menu">
      <figure class="dropdownmenu-wrapper">
    <?php
        ...
        if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key)) {
            ...
            <div class="product">
              <figure class="product-image-container">
                <a href="<?= $product_permalink ?>" class="product-image"><img src="<?= $image; ?>"
                                                       alt="<?= $_product->get_name() ?>" width="80" height="80"/></a>
    ...
    <div class="dropdown-cart-action">
        ...
        ?>
        <a href="<?= wc_get_cart_url() ?>" class="btn btn-dark btn-block"> View Cart</a>
        <br>
        <a href="<?= wc_get_checkout_url() ?>" class="btn btn-dark btn-block">Checkout</a>
    </div>
    </div
    </div>
...
<?php else : ?>
    ...
    <p class="woocommerce-mini-cart__empty-message d-none"><?php esc_html_e('No products in the cart.', 'woocommerce'); ?></p>
